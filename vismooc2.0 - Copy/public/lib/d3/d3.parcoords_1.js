...
pc.render.queue = function() {
  if (__.brushed) {
      ...
      //    }
      //    __.brushed = brushedTemp;
      //    //var l = pc.svg.selectAll("text.label");
      //    //console.log(l);
      //    //for (var mi = 0; mi < peakNum; mi++) {
      //    //    l[0][mi + attrAxisNum].innerHTML = 'Peak' + countfororder[mi].index;
      //    //}
      //    //console.log(l);
      //}
          rqueue(__.brushed);
...
function single_path(d, ctx) {
	__.dimensions.map(function(p, i) {
        ...
        var attrAxisNum = 8;
        ctx.lineWidth = 0.8;
        //if(i > 0 && i <= attrAxisNum){
        //    ctx.lineTo(position(p), yscale[p](d[p]));
        //}
        ctx.stroke();
        ctx.beginPath();

        var videoLength = [905, 215, 1226, 851, 663, 1195, 881, 470, 810, 373, 713, 401, 539, 902, 745, 571, 297];
        ...
        //if(i > 6)   ctx.lineWidth = Math.floor((566*3)/videoLength[i - 6]);
        //if(i >= attrAxisNum) {
...
(function() {
  ...
  function selected() {
    ...
    //detect whether peak axis is brushed
